...
ligaNOS2019 = pd.read_csv("./ligaNOS/portugal-liga-i-2018-to-2019.csv", header=None, low_memory=False)
ligaNOS2020 = pd.read_csv("./ligaNOS/portugal-liga-i-2019-to-2020.csv", header=None, low_memory=False)

ligaNOS2019Results = ligaNOS2019["FTR"]  #full time Result   H-home D-draw A-away
ligaNOS2020Results = ligaNOS2020["FTR"]  #transformar em -1 0 1 e aplicar tanh?
