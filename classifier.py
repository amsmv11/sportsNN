...
# X_train = pd.read_cvs("nomedofile.cvs", header=None)  X=inputs
# Y_train = pd.read_cvs("nomedofile.cvs", header=None)  Y=results
# X_test = pd.read_cvs("nomedofile.cvs", header=None)
# Y_test = pd.read_cvs("nomedofile.cvs", header=None)


#initialize the ANN
classifier = Sequencial()
